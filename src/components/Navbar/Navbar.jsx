...
const Navbar = () => {
  ...
  const yogasuthra = (
    <NavLink to="/yogasuthra" className={linkClass}>
      YOGASUTHRA
    </NavLink>
  );
  const booking = <NavLink to="/booking" className={linkClass}>BOOKING CALENDAR</NavLink>;
              ...
              <div className="dropdown">
                <label tabIndex={1} className="btn btn-ghost lg:hidden">
                  <svg
                    ...
                    className="h-[50px] text-neutral-800 w-[50px]"
                    fill="none"
                    viewBox="0 0 24 24"
                    stroke="currentColor"
                  >
                ...
                <ul
                  tabIndex={0}
                  className=" menus menu-sm dropdown-content text-neutral-800 py-4 z-[10] rounded-box -left-20 shadow-md bg-sun"
                >
                  ...
                  <li className="text-4xl px-3">{booking }</li>
                  ...
                  {user ? (
                    <>
                      <Link
                        ...
                        className=" py-2 px-4 rounded-full font-bold bg-white text-gray-500 md:ml-4 lg:ml-6"
                      >
                        Logout
                      </Link>
                    </>
                        ...
                        <>
                          <div className="w-10 rounded-full flex items-center">
                            <img
                              src={
                                user.photoURL == null
                                  ? "https://i.ibb.co/2vkJbGD/images.png"
                                  : user.photoURL
                              }
                              alt=""
                            />
                          ...
                          <p className="font-mono">
                            {user.displayName == null ? "MR" : user.displayName}
                          </p>
                        </>
                      ) : (
                        <></>
