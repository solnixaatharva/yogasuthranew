        ...
        <div>
            <div className="max-w-7xl mx-auto px-2 md:px-2 lg:px-0">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-5 my-5" >
                    <div data-aos="fade-right" className="border bg-neutral-50 p-10 flex gap-5 items-center">
                        <div>
                    ...
                    <div data-aos="zoom-in" className="border bg-neutral-50 p-10 flex gap-5 items-center">
                        <div>
                    ...
                    <div data-aos="fade-left" className="border bg-neutral-50 p-10 flex gap-5 items-center">
                        <div>
