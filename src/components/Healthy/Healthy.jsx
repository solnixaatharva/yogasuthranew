                                ...
                                <div className="carousel-item h-full ">
                                    ...
                                    <div className="card card-compact bg-neutral-100  shadow-xl">
                                        ...
                                        <div className="card-body text-center ">
                                            <h2 className="text-3xl font-bold text-center text-neutral-800 p-2">YOGA COMFORT MAT</h2>
                                            <p className="text-lg text-brand font-medium p-2 ">Form $50.00</p>
                                        </div>
                                    </div>
                                </div>
                                <div  className="carousel-item h-full ">
                                    ...
                                    <div className="card card-compact bg-neutral-100  shadow-xl">
                                        ...
                                        <div className="card-body text-center ">
                                            <h2 className="text-3xl font-bold text-center text-neutral-800 p-2">YOGA COMFORT SHOES</h2>
                                            <p className="text-lg text-brand font-medium p-2 ">Form $55.00</p>
                                        </div>
                                    </div>
                                </div>
                                <div className="carousel-item h-full ">
                                    ...
                                    <div className="card card-compact bg-neutral-100  shadow-xl">
                                        ...
                                        <div className="card-body text-center ">
                                            <h2 className="text-3xl font-bold text-center text-neutral-800 p-2">YOGA COMFORT STRIPE TIGHTS</h2>
                                            <p className="text-lg text-brand font-medium p-2 ">Form $500.00</p>
                                        </div>
                                    </div>
                                </div>
                                <div className="carousel-item h-full ">
                                    ...
                                    <div className="card card-compact bg-neutral-100  shadow-xl">
                                        ...
                                        <div className="card-body text-center ">
                                            <h2 className="text-3xl font-bold text-center text-neutral-800 p-2">YOGA COMFORT WARE FREE SPORTS TOPS</h2>
                                            <p className="text-lg text-brand font-medium p-2 ">Form $50.00</p>
                                        </div>
                                    </div>
                                </div>
